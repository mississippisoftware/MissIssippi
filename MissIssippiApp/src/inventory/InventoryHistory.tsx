...
export default function InventoryHistory() {
  ...
  return (
    ...
    >
      ...
      <div className="catalog-page-toolbar inventory-history-filters">
        <PageFiltersBar
          searchLabel=""
          searchValue={searchText}
          searchPlaceholder="Quick search batch id or timestamp"
          ...
          advancedFilters={
            <div className="page-filters-advanced-grid">
              <div className="page-filter-field">
                <label className="page-filters-label">Source</label>
                <select
                  value={sourceFilter}
                  onChange={(event) =>
              ...
              <div className="page-filter-field">
                <label className="page-filters-label">Range</label>
                <select
                  value={rangeFilter}
                  onChange={(event) => setRangeFilter(event.target.value as RangeOption)}
      ...
      <div className="content-card inventory-history-card">
        <div className="inventory-history-card-header">
          ...
          <div className="inventory-history-detail-subtitle">Double-click to view more details.</div>
        </div>
                ...
                <div key={batchId} className="inventory-history-section">
                  ...
                  <div className="inventory-history-table-wrapper">
                    {detailsView === "table" ? (
                      <>
                        {sizeError ? (
                          <div className="pt-error-notice">Failed to load sizes: {sizeError}</div>
                        ) : null}
                        {!detailLoading && detail && detail.lines.length === 0 && !sizeLoading ? (
                          <div className="pt-table-empty">No detail rows for this batch.</div>
                        ) : (
                          <InventoryTable
                            embedded
